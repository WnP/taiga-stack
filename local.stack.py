...
SITES["front"]["scheme"] = "http"  # noqa
SITES["front"]["domain"] = "localhost:8080"  # noqa
...
tgbi = INSTALLED_APPS.index('taiga.base')  # noqa
APPS = INSTALLED_APPS[:]  # noqa
INSTALLED_APPS = APPS[:tgbi] + ["taiga_contrib_time_tracking"] + APPS[tgbi:]

EVENTS_PUSH_BACKEND = "taiga.events.backends.rabbitmq.EventsPushBackend"
EVENTS_PUSH_BACKEND_OPTIONS = {
    "url": "amqp://taiga:secret@rabbitmp:5672/taiga"
}
...
# IMPORTERS["asana"] = {
#     "active": True, # Enable or disable the importer
#     "callback_url": "{}://{}/project/new/import/asana".format(SITES["front"]["scheme"],  # noqa
#                                                               SITES["front"]["domain"]),  # noqa
